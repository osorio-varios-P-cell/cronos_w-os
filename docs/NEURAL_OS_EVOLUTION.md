# CRONOS W-OS v2.5 - Neural Fable Edition

## 🧠 Fusión: Obsidian + Anthropic Fable 5

Esta versión representa la cúspide de la inteligencia operativa soberana, fusionando la gestión del conocimiento estructurado (**Obsidian**) con el razonamiento autónomo de grado científico (**Fable 5**).

### 🚀 Funcionalidades Clave:

1.  **Cerebro Digital Local-First (v2.4):**
    - El sistema operativo gestiona archivos Markdown como nodos en el `GraphKernel`.
    - Enlaces bidireccionales reales entre procesos, drivers y notas de usuario.
    - Motor **Hive Dataview** para realizar consultas complejas sobre el estado del conocimiento.
